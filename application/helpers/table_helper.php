...
function get_customers_manage_table($people, $controller)
{
    ...
    $headers = ['<input type="checkbox" id="select_all" />',
...
function get_customer_data_row($person, $controller)
{
    ...
    if ($lc != '') {
        $btnCredit = anchor($controller_name."/account/$person->person_id/pay/width:650/height:450", 'Account', ['class' => 'thickbox small_button', 'title' => 'Account Balance']);
    } else {
        $btnCredit = '';
    }

    if ($CI->Employee->has_privilege('add', $controller_name)) {
        $table_data_row .= '<td width="5%">'.anchor($controller_name."/view/$person->person_id/width:$width", $CI->lang->line('common_edit'), ['class' => 'thickbox small_button', 'title' => $CI->lang->line($controller_name.'_update')]).$btnCredit.'</td>';
    } else {
...
function get_person_data_row($person, $controller)
{
    ...
    if ($CI->Employee->has_privilege('add', $controller_name)) {
        $table_data_row .= '<td width="5%">'.anchor($controller_name."/view/$person->person_id/width:$width", $CI->lang->line('common_edit'), ['class' => 'thickbox small_button', 'title' => $CI->lang->line($controller_name.'_update')]).'</td>';
    } else {
        $table_data_row .= '<td width="5%"></td>';
    }
    $table_data_row .= '</tr>';
...
function get_supplier_data_row($supplier, $controller)
{
    ...
    if ($CI->Employee->has_privilege('update', $controller_name)) {
        $table_data_row .= '<td width="5%">'.anchor($controller_name."/view/$supplier->person_id/width:570/height:425", $CI->lang->line('common_edit'), ['class' => 'thickbox small_button', 'title' => $CI->lang->line($controller_name.'_update')]).'</td>';
    } else {
        $table_data_row .= '<td width="5%"></td>';
    }
    $table_data_row .= '</tr>';
...
function get_item_data_row($item, $controller)
{
    ...
    if ($CI->Employee->has_privilege('update', $controller_name)) {
        $table_data_row .= '<td width="5%">'.anchor($controller_name."/view/$item->item_id/width:$width", $CI->lang->line('common_edit'), ['class' => 'small_button thickbox', 'title' => $CI->lang->line($controller_name.'_update')]).'</td>';
    } else {
        $table_data_row .= '<td width="5%"></td>';
    }
    $table_data_row .= '<td width="10%">'.anchor($controller_name."/count_details/$item->item_id/width:$width", $CI->lang->line('common_det'), ['class' => 'small_button thickbox', 'title' => $CI->lang->line($controller_name.'_details_count')]).'</td>'; //inventory details
    ...
    if ($item->is_service) {
        ...
        if ($CI->Employee->isAdmin()) {
            ...
            $table_data_row .= '<td width="10%">'.anchor('home/confirm_user/'.$controller_name."-inventory-$item->item_id/".$CI->lang->line($controller_name.'_count').'/660/465/'.'width:350/height:180', $CI->lang->line('common_inv'), ['id' => 'confirm-user', 'class' => 'small_button thickbox', 'title' => $CI->lang->line($controller_name.'_count')]);
        }
    }
...
function get_location_data_row($location, $controller)
{
    ...
    if ($location->active) {
        $active = $CI->lang->line('location_yes');
    }
...
function get_giftcard_data_row($giftcard, $controller)
{
    ...
    if ($CI->Employee->has_privilege('update', $controller_name)) {
        $table_data_row .= anchor("$controller_name/view/$giftcard->giftcard_id/width:$width/height:$height", $CI->lang->line('common_edit'), ['class' => 'small_button thickbox', 'title' => $CI->lang->line($controller_name.'_update')]);
    }
    $table_data_row .= '</td>';
...
function get_item_kit_data_row($item_kit, $controller)
{
    ...
    if ($CI->Employee->has_privilege('update', $controller_name)) {
        $table_data_row .= '<td width="5%">'.anchor($controller_name."/view/$item_kit->item_kit_id/width:$width", $CI->lang->line('common_edit'), ['class' => 'thickbox small_button', 'title' => $CI->lang->line($controller_name.'_update')]).'</td>';
    } else {
        $table_data_row .= '<td width="5%"></td>';
    }
...
function get_service_data_row($service, $controller)
{
    ...
    switch ($service->status) {
        case 3:
            $hidden = ['item' => '3', 'customer_id' => $service->person_id, 'service' => $service->service_id];

            $table_data_row .= '<td width="5%">'.form_open('sales/add/', '', $hidden).form_submit(['value' => $CI->lang->line('services_pay'), 'class' => 'small_button']).form_close();
            $table_data_row .= anchor($controller_name."/view/$service->service_id/width:$width", $CI->lang->line('common_edit'), ['class' => 'small_button thickbox', 'title' => $CI->lang->line($controller_name.'_update')]);
            $table_data_row .= '</td>';
            break;
        case 100:
        ...
        default:
            ...
            $b_note = anchor($controller_name."/notes_view/$service->service_id/width:$width", $CI->lang->line('services_btn_notes'), ['class' => 'small_button thickbox', 'title' => $CI->lang->line($controller_name.'_list_notes')]);
            $b_edit = anchor($controller_name."/view/$service->service_id/width:$width", $CI->lang->line('common_edit'), ['class' => 'small_button thickbox', 'title' => $CI->lang->line($controller_name.'_update')]);
