<?php echo form_open('employees/save_profile_employee/'.$profile, ['id' => 'employee_form']); ?>
<div>
	<h3><?php echo $this->lang->line('employees_profile_per'); ?></h3><hr>
	<div class="field_row clearfix" style="margin: 0 0 5px 0">	
		<?php echo form_label($this->lang->line('employees_profile_per_name').':', 'name', ['class' => 'lable-form-required'])?>
		<div>
		<?php 
