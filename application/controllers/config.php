...
class config extends Secure_area
{
    ...
    public function save()
    {
        ...
        switch ($data['upload_status']) {
            case '-1':case '0':
                echo json_encode(['x' => $data['upload_status'], 'success' => false, 'message' => $data['upload_message']]);
                break;
            case '1':case '2':
                    if ($this->Appconfig->batch_save($batch_save_data)) {
                        ...
                        echo json_encode(['success' => true, 'Upstatus' => $data['upload_status'], 'data' => $data, 'message' => $this->lang->line('config_saved_successfully')]);
                    }
                break;
        }
    }
