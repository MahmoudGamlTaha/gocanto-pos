...
class Inventories_compare extends Secure_area
{
    ...
    {
        $response = ['status' => 0, 'msg' => 'Error sending to administrator.'];
    ...
    public function cleaned_comments($string)
    {
        ...
        return ['ids' => $arra2, 'like' => $string];
    }

    public function html_email($cometarios)
    {
