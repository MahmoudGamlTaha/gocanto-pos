            ...
            if ($this->Employee->isAdmin()) {
                ?>
			 		<div class='big_button' style='margin: 0px 5px;float:left;'>
			 			<span><a href="<?php  echo site_url($controller_name.'/profile_employee');
                ?>" style="text-decoration: none;color: hsl(208, 45%, 41%);" >
			 			<?php echo $this->lang->line('employees_profile_per');
                ?></a></span>
		 			</div>
		<?php 
            }
            ...
            if ($this->Employee->has_privilege('add', $controller_name)) {
                ...
                ['class' => 'thickbox none', 'title' => $this->lang->line('customers_excel_title')]);
