...
class Summary_credits extends Report
{
    ...
    {
        return [$this->lang->line('reports_credits_date'), $this->lang->line('reports_credits_reference'), $this->lang->line('reports_credits_amount'), $this->lang->line('reports_credits_balance'), $this->lang->line('reports_credits_period'), $this->lang->line('customers_lbl_td_type'), $this->lang->line('reports_credits_status')];
    }

    public function getDataColumnsOverdue()
    {
        return [' ', $this->lang->line('reports_credits_amount'), $this->lang->line('reports_credits_period'), $this->lang->line('reports_credits_date'), $this->lang->line('reports_credits_status'), 'Ended'];
    }
