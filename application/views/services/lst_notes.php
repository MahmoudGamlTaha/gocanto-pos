<div>
			...
			<ul style=" list-style: none">
				...
				<li style="margin: 0 0 5px 0; border-bottom: 1px solid #f4f4f4;">
                    ...
                    if ($service_info->state != '') {
                        $address .= ($address != '' ? ', ' : ' ').$service_info->state;
                    }
                    if ($service_info->zip != '') {
                        $address .= ($address != '' ? ', ' : ' ').$service_info->zip;
                    }
                    if ($service_info->address_1 != '') {
                        $address .= ($address != '' ? ', ' : ' ').$service_info->address_1;
                    }
                    echo $address; ?>
				</li>
	...
	<div class="field_row clearfix">
		...
		<?php echo form_open('services/add_note', ['id' => 'notes_form']); ?>
