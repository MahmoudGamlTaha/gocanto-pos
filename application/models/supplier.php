...
class supplier extends Person
{
    ...
    */
    ...
    public function save(&$person_data, &$supplier_data, $supplier_id = false)
    {
        $success = false;
    ...
    public function update_account($supplier_id)
    {
        $account =  [
    ...
    */
    ...
    public function delete($supplier_id)
    {
        ...
        return $this->con->update('suppliers', ['deleted' => 1]);
    }
    ...
    */
    ...
    public function get_suppliers_search_suggestions($search, $limit = 25)
    {
        $suggestions = [];
