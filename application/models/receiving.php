...
class receiving extends CI_Model
{
    ...
    public function save($items, $supplier_id, $employee_id, $comment, $payment_type, $amount_tendered, $receiving_id = false)
    {
        if (count($items) == 0) {
            return -1;
        }
        ...
        foreach ($items as $line => $item) {
            ...
            $item_data = ['quantity' => $cur_item_info->quantity + $item['quantity']];
