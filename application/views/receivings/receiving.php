<div id="register_wrapper">
	<?php echo form_open('receivings/change_mode', ['id' => 'mode_form']); ?>
		<span><?php echo $this->lang->line('recvs_mode') ?>:</span>&nbsp;
		<?php echo form_dropdown('mode', $modes, $mode, 'onchange="$(\'#mode_form\').submit();"'); ?>
		</form>
		<?php echo form_open('receivings/add', ['id' => 'add_item_form']); ?>
		...
		<?php echo form_input(['name' => 'item', 'id' => 'item', 'size' => '40']); ?>
		<div id="new_item_button_register" >
                ...
                ['class' => 'thickbox none', 'title' => $this->lang->line('sales_new_item')]);
                ?>
		</div>
	</form>
    ...
    foreach (array_reverse($cart, true) as $line => $item) {
        ...
        ?>
				<tr>
					<td><?php echo anchor("receivings/delete_item/$line", '['.$this->lang->line('common_delete').']');
        ?></td>
    ...
    ?>
					<td><?php echo form_input(['name' => 'price', 'value' => $item['price'], 'size' => '6']);
    ?></td>
				<?php 
} else {
    ?>
    ...
    ?>
        ...
        ?>
					<td><?php echo form_input(['type' => 'number', 'name' => 'gain', 'value' => 30, 'size' => '3']);
        ?></td>
					<td>
						<?php echo form_input(['name' => 'quantity', 'value' => $item['quantity'], 'size' => '2']);
        ?>
					</td>
        ...
        ?></td>
				<td><?php echo form_submit('edit_item', 'Update', 'class="small_button", style=" height: 26px"');
        ?></td>
				</tr>
				</form>
			<?php
...
<div id="overall_sale">
    ...
    if (isset($supplier)) {
        ...
        echo form_open('receivings/select_supplier', ['id' => 'select_supplier_form']);
        ?>
		<label id="supplier_label" for="supplier"><?php echo $this->lang->line('recvs_select_supplier');
        ?></label>
		<?php echo form_input(['name' => 'supplier', 'id' => 'supplier', 'size' => '30', 'value' => $this->lang->line('recvs_start_typing_supplier_name')]);
        ?>
		</form>
		<div style="margin-top:5px;text-align:center;">
		<h3 style="margin: 5px 0 5px 0"><?php echo $this->lang->line('common_or');
        ?></h3>
        ...
        ['class' => 'thickbox none', 'title' => $this->lang->line('recvs_new_supplier')]);
        ?>
		</div>
    ...
    ?>
	<div id="finish_sale">
		<?php echo form_open('receivings/complete', ['id' => 'finish_sale_form']);
    ?>
			<br />
			<label id="comment_label" for="comment"><?php echo $this->lang->line('common_comments');
    ?>:</label>
    ...
    ?></td>
					<td><?php echo form_dropdown('payment_type', $payment_options);
    ?> </td>
	        	</tr>
		        <tr>
			        <td><?php echo $this->lang->line('sales_amount_tendered').':   ';
    ?></td>
					<td><?php echo form_input(['name' => 'amount_tendered', 'value' => '', 'size' => '10']);
    ?> </td>
		        </tr>
	        </table>
	        <br />
