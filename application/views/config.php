...
<?php echo form_open_multipart('config/save/', ['id' => 'config_form']); ?>
...
<div class="box-form-view">
	...
	<div class="field_row clearfix" style="display:block;margin: 0 0 5px 0">
		<div style="width: 250px; float: left">
			<div class="field_row clearfix" style="display:block;">	
				<?php echo form_label($this->lang->line('config_company').':', 'company', ['class' => 'lable-form-required', 'style' => 'width: 160px;']); ?>
				<div>
					<?php 
                        echo form_input(
                            [
		...
		<div style="width: 250px; float: left">
			<div class="field_row clearfix" style="display:block;">	
				<?php echo form_label($this->lang->line('config_phone').':', 'phone', ['class' => 'lable-form-required', 'style' => 'width: 160px;']); ?>
				<div>
					<?php 
                        echo form_input(
                            [
		...
		<div style="width: 250px; float: left">
			<div class="field_row clearfix" style="display:block;">	
				<?php echo form_label('Company Fax:', 'fax', ['class' => 'lable-form']); ?>
				<div>
					<?php 
                        echo form_input(
                            [
	...
	<div class="field_row clearfix" style="display:block;margin: 0 0 5px 0">
		<div style="width: 250px; float: left">
			<div class="field_row clearfix" style="display:block;">
				<?php echo form_label('Company Email:', 'email', ['class' => 'lable-form-required']); ?>
				<div>
					<?php 
                        echo form_input(
                            [
		...
		<div style="width: 250px; float: left">
			<div class="field_row clearfix" style="display:block;">	
				<?php echo form_label('Company '.$this->lang->line('config_website').':', 'website', ['class' => 'lable-form', 'style' => 'width:160px']); ?>
				<div>
					<?php 
                        echo form_input(
                            [
		...
		<div style="width: 100%; float: left; margin-top: 5px">
			<div class="field_row clearfix" style="display:block;">
			<?php echo form_label('Company '.$this->lang->line('common_logo').':', 'logo', ['class' => 'lable-form']); ?>
		...
		<div class="field_row clearfix" style="display:block;margin: 0 0 5px 0">
			<div class="field_row clearfix" style="display:block;">	
				<?php echo form_label($this->lang->line('config_address').':', 'addresslabel', ['class' => 'lable-form-required', 'style' => 'width:160px;']); ?>
				<div>
					<?php 
                        echo form_textarea(
                            [
	...
	<div class="field_row clearfix" style="margin: 0 0 5px 0;display:block;">
		<div>
			<div class="field_row clearfix" style="float: left;margin-right: 70px;">
				...
				<?php echo form_label($this->lang->line('config_service_price').':', 'servicelabel', ['class' => 'lable-form-required', 'style' => 'width:160px;']); ?>
				</div>
				<div>
					<?php 
                        echo form_input(
			...
			<div class="field_row clearfix" style="margin: 0 0 5px 0;float: left;margin-right: 80px;">
				<div style="height: 27px;">
				<?php echo form_label($this->lang->line('config_service_item_percentage').':', 'default_percentagelabel', ['class' => 'lable-form-required', 'style' => 'width:160px;']); ?>
				</div>
				<div>
					<?php 
                        echo form_input(
	...
	<div class="field_row clearfix" style="margin: 0 0 5px 0;display:block;">
		<div>
			<div class="field_row clearfix" style="float: left;margin-right: 70px;">
				<div style="height: 27px;">
				<?php echo form_label($this->lang->line('config_default_tax_rate_1').':', 'default_tax_1_rate', ['class' => 'lable-form-required', 'style' => 'width:160px;']); ?>
				</div>
				<div>
					<?php 
                        echo form_input(
			...
			<div class="field_row clearfix" style="margin: 0 0 5px 0;float: left;margin-right: 80px;">
				<div style="height: 27px;">
				<?php echo form_label($this->lang->line('config_default_tax_rate_2').':', 'default_tax_1_rate', ['class' => 'lable-form', 'style' => 'width:160px;']); ?>
				</div>
				<div>
					<?php 
                        echo form_input(
		...
		<div class="field_row clearfix" style="display:block;">
			<div style="height: 27px;">
			<?php echo form_label($this->lang->line('config_currency_symbol').':', 'currency_symbol', ['class' => 'lable-form', 'style' => 'width:160px;']); ?>
			</div>
			<div>
				<?php 
                    echo form_input(
		...
		<div class="field_row clearfix" style="display:block;">
			<div  style="float: left;">
				<div>
				<?php echo form_label($this->lang->line('config_print_after_sale').':', 'print_after_sale', ['class' => 'lable-form', 'style' => 'width:250px;']); ?>
				</div>
				<div style="height: 27px;">
					<?php 
                        echo form_checkbox(
			...
			<div style="float: left;">
				<div>
				<?php echo form_label($this->lang->line('config_alert_after_sale').':', 'alert_after_sale', ['class' => 'lable-form', 'style' => 'width:270px;']); ?>
				</div>
				<div style="height: 27px;">
					<?php 
                        echo form_checkbox(
	...
	<div class="field_row clearfix" style="margin: 0 0 5px 0;display:block;">
		<div class="field_row clearfix" style="float: left">	
			<?php echo form_label($this->lang->line('config_language').':', 'language', ['class' => 'lable-form', 'style' => 'width:170px;']); ?>
			<div>
				<?php 
		...
		<div class="field_row clearfix" style="display:block;">	
		<?php echo form_label($this->lang->line('config_timezone').':', 'timezone', ['class' => 'lable-form', 'style' => 'width:300px;']); ?>
			<div>
			...
			<div class="field_row clearfix;display:block;">	
				<?php 
                    if ($this->Employee->isAdmin()) {
                        ...
                        ['class' => 'thickbox none', 'title' => $this->lang->line('config_backup')]);
                        ...
                        ['class' => 'thickbox none', 'title' => $this->lang->line('config_recover')]);
                    }
                ?>
			</div>
		</div>
