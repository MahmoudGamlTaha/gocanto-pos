...
<div id="edit_sale_wrapper">
	...
	<?php echo form_open('sales/save/'.$sale_info['sale_id'], ['id' => 'sales_edit_form']); ?>
	<ul id="error_message_box"></ul>
	
	<div class="field_row clearfix">
	<?php echo form_label($this->lang->line('sales_receipt').':', 'customer'); ?>
		<div class='form_field'>
			<?php echo anchor('sales/receipt/'.$sale_info['sale_id'], 'POS '.$sale_info['sale_id'], ['target' => '_blank']); ?>
		</div>
	</div>
	...
	<?php echo form_label($this->lang->line('sales_date').':', 'date'); ?>
		<div class='form_field'>
			<?php echo form_input(['name' => 'date', 'value' => date('m/d/Y', strtotime($sale_info['sale_time'])), 'id' => 'date']); ?>
		</div>
	</div>
	...
	<?php echo form_label($this->lang->line('sales_comment').':', 'comment'); ?>
		<div class='form_field'>
			<?php echo form_textarea(['name' => 'comment', 'value' => $sale_info['comment'], 'rows' => '4', 'cols' => '23', 'id' => 'comment']); ?>
		</div>
	</div>
	...
	<?php echo form_open('sales/delete/'.$sale_info['sale_id'], ['id' => 'sales_delete_form']); ?>
		<?php
        echo form_submit([
            'name'  => 'submit',
            'id'    => 'submit',
