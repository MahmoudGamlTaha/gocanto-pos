...
class Summary_suppliers extends Report
{
    ...
    {
        return [$this->lang->line('reports_supplier'), $this->lang->line('reports_subtotal'), $this->lang->line('reports_total'), $this->lang->line('reports_tax'), $this->lang->line('reports_profit')];
    }
