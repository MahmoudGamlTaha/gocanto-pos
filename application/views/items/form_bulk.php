<?php echo form_open('items/bulk_update/', ['id' => 'item_form']); ?>
<div>
	<h3><?php echo $this->lang->line('items_basic_information'); ?></h3><hr>
	<div class="field_row clearfix">
		<div style="width: 210px; float: left">
			<div class="field_row clearfix">	
				<?php echo form_label($this->lang->line('items_name').':', 'name', ['class' => 'lable-form', 'style' => 'float:none;', 'style' => 'float:none;']); ?>
				<div>
				<?php echo form_input([
                    'name'  => 'name',
                    'id'    => 'name',
		...
		<div style="width: 210px; float: left">
			<div class="field_row clearfix">	
				<?php echo form_label($this->lang->line('items_category').':', 'category', ['class' => 'lable-form', 'style' => 'float:none;']); ?>
				<div>
				<?php echo form_input([
                    'name'  => 'category',
                    'id'    => 'category',
		...
		<div style="width: 210px; float: left">
			<div class="field_row clearfix">	
				<?php echo form_label($this->lang->line('items_supplier').':', 'supplier', ['class' => 'lable-form', 'style' => 'float:none;']); ?>
	...
	<div class="field_row clearfix">
		<div style="width: 210px; float: left">
			<div class="field_row clearfix">	
				<?php echo form_label($this->lang->line('items_cost_price').':', 'cost_price', ['class' => 'lable-form', 'style' => 'float:none;']); ?>
				<div>
				<?php echo form_input([
                    'name'  => 'cost_price',
                    'size'  => '8',
		...
		<div style="width: 210px; float: left">
			<div class="field_row clearfix">	
				<?php echo form_label($this->lang->line('items_unit_price').':', 'unit_price', ['class' => 'lable-form', 'style' => 'float:none;']); ?>
				<div>
				<?php echo form_input([
                    'name'  => 'unit_price',
                    'size'  => '8',
	...
	<div class="field_row clearfix">
		<div style="width: 210px; float: left">
			<div class="field_row clearfix">	
				<?php echo form_label($this->lang->line('items_reorder_level').':', 'reorder_level', ['class' => 'lable-form', 'style' => 'float:none;']); ?>
				<div>
				<?php echo form_input([
                    'name'  => 'reorder_level',
                    'id'    => 'reorder_level',
	...
	<div class="field_row clearfix">
		<div style="float: left">
			<div class="field_row clearfix">	
				<?php echo form_label($this->lang->line('items_description').':', 'description', ['class' => 'lable-form', 'style' => 'float:none;']); ?>
				<div>
	...
	<div class="field_row clearfix">
		<div style="width: 210px; float: left">
			<div class="field_row clearfix">
				<?php echo form_label($this->lang->line('items_allow_alt_desciption').':', 'allow_alt_description', ['class' => 'lable-form', 'style' => 'float:none;']); ?>
				<div><?php echo form_dropdown('allow_alt_description', $allow_alt_desciption_choices); ?></div>
			</div>
		</div>
		<div style="width: 210px; float: left">
			<div class="field_row clearfix">
				<?php echo form_label($this->lang->line('items_is_serialized').':', 'is_serialized', ['class' => 'lable-form', 'style' => 'float:none;']); ?>
