...
<div id="title_bar">
	...
	<div id="new_button">
		...
		<?php
            ...
            ['class' => 'thickbox none', 'title' => $this->lang->line('employees_profile_per_new')]);
        ?>
	</div>
</div>
	...
	<table class="tablesorter" id="sortable_table">
        ...
        if (is_array($profiles)) {
			...
			<tr>
				...
				<td width="65%" ><?php echo $row['module'];
                ?></td>
				<td width="5%"><?=anchor($controller_name.'/form_profile_employee/'.$row['name'].'/width:680', $this->lang->line('common_edit'), ['class' => 'thickbox small_button', 'title' => 'Edit Profile'])?></td>
			</tr>
		<?php 
            }
        } else {
            echo '<tr><td colspan="3">'.$profiles.'</td></tr>';
        } ?>
		</tbody>
	</table>
</div>
