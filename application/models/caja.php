...
{
    public $con; //Objeto de conexsion con la bd
    ...
    {
        return [$this->lang->line('reports_payment_type'), $this->lang->line('reports_total')];
    }

    public function getCierreDetails()
    {
    ...
    public function getDetailsPayments()
    {
