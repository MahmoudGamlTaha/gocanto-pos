<table id="suspended_sales_table">
    ...
    foreach ($suspended_sales as $suspended_sale) {
        ?>
		<tr>
			<td><?php echo $suspended_sale['sale_id'];
        ?></td>
			<td><?php echo date('m/d/Y', strtotime($suspended_sale['sale_time']));
        ?></td>
			<td>
				<?php
        ...
        ?>
			...
			<td><?php echo $suspended_sale['comment'];
        ?></td>
			<td>
				<?php 
        ...
        ?>
				<input type="submit" name="submit" value="<?php echo $this->lang->line('sales_unsuspend');
        ?>" id="submit" class="small_button float_right"></td>
				</form>
		</tr>
	<?php
